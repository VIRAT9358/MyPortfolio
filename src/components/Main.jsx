...
import {FaTwitter,FaFacebookF,FaLinkedin,FaGithubAlt} from 'react-icons/fa'
const Main = () => {
  return (
    <div id="main">
      <img
      ...
      <div className="w-full h-screen absolute top-0 left-0 bg-white/20 ">
        ...
        <div className="max-w-[700px] m-auto top-0 h-full w-full flex flex-col justify-center lg:items-start items-center" >
          <h1 className="sm:text-5xl text-4xl font-bold text-gray-800 ">I am Virat Srivastava</h1>
